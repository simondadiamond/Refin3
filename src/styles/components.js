...
export const Card = styled(motion.div)`
  padding: 2rem;
  background: ${({ theme }) => theme.isDark ? '#2D2D3A' : '#F5F5F5'}; /* Light mode background */
  border-radius: 1rem;
  text-align: ${({ center }) => center ? 'center' : 'left'};
...
export const Input = styled.input`
  padding: 0.75rem;
  background: #333333; /* Darker fill for input fields in dark mode */
...
export const TextArea = styled.textarea`
  padding: 0.75rem;
  background: #333333; /* Darker fill for text area in dark mode */
  border: 1px solid #CCCCCC; /* Subtle border */
  border-radius: 0.5rem;
  font-size: 1rem;
  min-height: 150px;
